    ...
    try {
      ...
      response.json().then((data: Array<BloqueDeTrabajo>) => {
        ...
        data.forEach((bloqueDeTrabajo: BloqueDeTrabajo) => {
          ...
          if (
            recurso.legajo == bloqueDeTrabajo.legajo &&
            bloqueDeTrabajo.codTarea.toString() == tareaActual.id_tarea &&
            bloqueDeTrabajo.codProyectoDeLaTarea.toString() ==
              tareaActual.id_proyecto
          ) {
